...
interface AnimatedMarketRateProps {
  price: number | null;
...
function AnimatedMarketRate({ price, buybackPrice, change, status, prefix = "", isInteger = false }: AnimatedMarketRateProps) {
